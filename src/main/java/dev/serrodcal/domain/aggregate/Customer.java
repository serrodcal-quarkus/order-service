package dev.serrodcal.domain.aggregate;

import dev.serrodcal.domain.entities.Order;
import dev.serrodcal.domain.vos.CustomerEmail;
import dev.serrodcal.domain.vos.CustomerName;
import dev.serrodcal.exceptions.ProductAlreadyExistsException;
